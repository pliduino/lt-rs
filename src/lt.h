...
namespace libtorrent
{
    ...
    std::unique_ptr<lt::torrent_handle> lt_session_add_torrent(session &session, const lt::add_torrent_params &params);
    std::unique_ptr<AlertListCpp> lt_session_pop_alerts(lt::session &ses);
    void lt_session_async_add_torrent(session &session, const lt::add_torrent_params &params);
